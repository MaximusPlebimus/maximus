...
/* 3. Den Runenpuzzle-�nderungen von Po1son*/
/* 4. Diversen �nderungen von Latzhosentr�ger */
/* 5. Diversen �nderungen von sniGG */

/* Dank geht an alle, die Inhalte zur Verf�gung gestellt haben, insbesondere Sotrax und isdrador. */
/* Auch bedanke ich mich bei allen, die tatkr�ftig geholfen haben. */

/* Einige Inhalte dieses Styles werden mittlerweile von vielen anderen Styles �bernommen. Wenn jemand etwas �bernehmen will, muss er eine PN an Latzhosentr�ger schreiben. */



/* global */
	p,ul,ol,body:not(.framemapbg) div,td,span,layer,table,body	 
...
/* banner stuff */
	...
	.bannermodquickbar	{ background: transparent !important; }
...
/* text classes */
	...
	.chattextmod 	{ color: #9A1085; font-size: 13px; }
...
/* Wetter */
	...
	.chattextinfo:before 	{ content: "Bemerkenswert: "; font-weight: bold; color: #A37300; } /* Bemerkenswertzeile - l�schen/rauskommentieren wenn unerw�nscht */
...
/* main module */
	td.mainheader 		{ font-size: 35px; background-image: url(images/headerbg.jpg); background-repeat: repeat-y; background-color: white; }
	table.areadescription 	{ border: 1px solid #FFDAA9; background-color: #FFF8EF; width: 100%; }
	td.areadescription 	{ padding: 0px; }
	tbody td.areadescription 	{ padding: 4px; }
	.imageborder 		{ border: 1px solid #C85424; background-color: #C85424; margin-right: 1px; margin-bottom: 1px;}
	p.maincaption 		{ font-weight: bold; font-size: 30px; padding: 1px 3px; background-image: url(images/headerbg.jpg); background-repeat: repeat-y; }
	p.maincaption2 		{ font-weight: bold; font-size: 12px; padding: 1px 3px; background-image: url(images/bluebg.jpg); background-repeat: repeat-y; }
	p.maindesc1 		{ padding: 1px 3px; background-color: #ECE9E6; border: 1px solid #D6CBC2; border-top: 1px; width: 300px; }
	p.maindesc2 		{ border: 1px solid #FFDAA9; background-color: #FFF8EF; width: 100%; }
	p.listplaceitemsrow 	{ padding: 1px 3px; background-color: #ECE9E6; border: 1px solid #D6CBC2; border-top: 0px; overflow: hidden; }
	p.listusersrow 		{ padding: 1px 3px; padding-left: 1px; background-color: #ECE9E6; border: 1px solid #D6CBC2; border-top: 0px; overflow: hidden; }
	p.listusersrow b:first-child { padding-left: 2px; }
...
.framemapbg td[id^="map"] a:after {
z-index: 2; width: 50px; position: absolute; left: 0px; top: 0px; line-height: 120%; font-size: 10px; font-weight: bold; text-align: center; color: #D20000; background: #CCCCCC; border-bottom: 1px solid #BABABA; opacity: 0.70; -moz-border-radius-bottomleft: 6px; -moz-border-radius-bottomright: 6px; -webkit-border-bottom-left-radius: 6px; -webkit-border-bottom-right-radius: 6px; 
}

.framemapbg .maptable[data-mapsize="7"] td[id^="map"] a:after { width: 35px; }
...
/* misc */
	...
	.framemapbg .maptable[data-mapsize="7"] a.nocango:after { width: 35px; height: 35px; }
...
/* Zust�nde blinken beim Auslaufen */
...
/* Inventar-Platzschaffende �nderungen */
...
/*Texteingabe gr��er: Modnachricht, Feuervogel, Post, Postvogel, Notizzettel...*/
